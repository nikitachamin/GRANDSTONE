<script setup>
import img1 from '@/assets/img/faq/faq.png';
            ...
            <div class="questions">
                <div class="question">
                    <div class="question__heading">
                        ...
                        <button class="btn" @click="toggleTheText(0)"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <p v-show="isVisible[0]" class="question__text">Привет</p>
                </div>
                  <div class="question">
                    <div class="question__heading">
                ...
                <p v-show="isVisible[1]" class="question__text">Для организации похорон необходимо получить несколько обязательных документов. В первую очередь оформляется медицинское свидетельство о смерти — его выдают в больнице, морге или поликлинике по месту жительства. С этим документом нужно обратиться в ЗАГС, где на основании медицинского свидетельства выдадут свидетельство о смерти.</p>
                </div>
                  <div class="question">
                    <div class="question__heading">
                ...
                <p v-show="isVisible[2]" class="question__text">Привет</p>
                </div>
                  <div class="question">
                    <div class="question__heading">
                ...
                <p v-show="isVisible[3]" class="question__text">Привет</p>
                </div>
                  <div class="question">
                    <div class="question__heading">
                ...
                <p v-show="isVisible[4]" class="question__text">Привет</p>
                </div>
                  <div class="question">
                    <div class="question__heading">
